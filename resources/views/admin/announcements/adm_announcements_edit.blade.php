          ...
          <div class="col">
            <div class="card">
                ...
                <div class="card-body py-4 col-xl-12">
                  <form class="needs-validation" novalidate="" id="form_announcement" method="post" action="{{action('Adm_AnnouncementsController@update',$id)}}" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <input type="hidden" name="_method" value="PATCH" />
                    <div class="form-row">
                      <div class="col-md-6 mb-3">
                        <label class="form-control-label" for="validationCustom01">Title</label>
                        <input type="text" class="form-control" id="validationCustom01" placeholder="Announcement Title" value="{{$Announcements->title}}" required="" name="ann_title">
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <div class="custom-file">
                          <input type="file" class="custom-file-input" id="validationCustom02" lang="en" name="ann_upload" value="{{$Announcements->filename}}">
                          <input type="hidden" name="ann_upload_" value="{{$Announcements->filename}}">
                          <label class="custom-file-label" for="validationCustom02">{{$Announcements->filename}}</label>
                        </div>
                        <div class="invalid-feedback">
                    ...
                    <div class="form-row">
                      <div class="col-md-12 mb-3">
                        ...
                        <div class="mb-3">
                          <input name="ann_about" type="hidden" value="{{$Announcements->contents }}">
