...
<!-- ======= Hero Section ======= -->
  <section id="food" class="d-flex flex-column justify-content-center align-items-center">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0">
              ...
              <div class="row icon-boxes">
                <div class="col-md-6">
                  ...
                  <p>5 days (30 hours) <br> Monday-Friday (8:00 am - 2:00 pm)</p>
                </div>
